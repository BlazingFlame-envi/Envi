...
class EquipementController extends AbstractController
{
    ...
    #[Route('/fequipement', name: 'app_equipementf')]
    public function index1(EquipementRepository $succesRepository): Response
    {
    ...
    public function index(EquipementRepository $equipementRepository,EntityManagerInterface $entityManagerInterface): Response
    {
        ...
        $role = $user->getRole();
        if ($role  != 'benevole') {
        $listEntreprise = $entityManagerInterface->getRepository(Equipement::class)->getEntrepriseByUser($user);
 ...
 #[Route('/equipement/fnew', name: 'app_equipement_fnew')]
    public function fnew(Request $request , EntityManagerInterface $entityManagerInterface)
    {
      ...
      // die();
        ...
        return $this->redirectToRoute('app_equipementf'); // Redirection vers une page d'accueil ou une autre page appropriée
    }
}
...
#[Route('/back', name: 'app_back_equipement')]
