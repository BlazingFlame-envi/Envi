 ...
 */
class getSuccesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SuccesRepository' shared autowired service.
     *
     * @return \App\Repository\SuccesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SuccesRepository.php';

        return $container->privates['App\\Repository\\SuccesRepository'] = new \App\Repository\SuccesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
