 ...
 */
class getEmplacementRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EmplacementRepository.php';

        return $container->privates['App\\Repository\\EmplacementRepository'] = new \App\Repository\EmplacementRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
