 ...
 */
class getTachesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TachesRepository' shared autowired service.
     *
     * @return \App\Repository\TachesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TachesRepository.php';

        return $container->privates['App\\Repository\\TachesRepository'] = new \App\Repository\TachesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
